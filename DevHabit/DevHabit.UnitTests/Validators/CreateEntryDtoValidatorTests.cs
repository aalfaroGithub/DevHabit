...
public sealed class CreateEntryDtoValidatorTests
{
    ...
    [Fact]
    public async Task Validate_ShouldNotReturnError_WhenAllPropertiesAreValid() // Converted to async because of the async nature of the validation method
    {
        // Arrange
    ...
    [Fact]
    public async Task Validate_ShouldReturnError_WhenHabitIdIsEmpty() // Converted to async because of the async nature of the validation method
    {
        // Arrange
        var dto = new CreateEntryDto
        {
