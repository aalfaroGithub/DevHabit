...
public sealed class GitHubTests(DevHabitWebAppFactory factory) : IntegrationTestFixture(factory)
{
    ...
    // Represent the reponse from the user endpoint
    ...
    // Represents the reponse from the events endpoint
    ...
    public async Task GetProfile_ShouldReturnUserProfile_WhenAccessTokenIsValid()
    {
        ...
        WireMockServer
            ...
            .RespondWith(Response.Create()
                ...
                .WithBodyAsJson(User));
        // If you want to customize the response body instead of using WithBodyAsJson, you can use WithBody and provide a JSON string. For example:
        /*.WithBody(
            """
            {
            "login": "..."
